                ...
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ url('/cvgenerator') }}">CV Generator</a></li>
                            <li><i class="fa fa-id-badge"></i><a href="{{ url('/pdfword') }}">PDF To Word</a></li>
                            <li><i class="fa fa-bars"></i><a href="{{ url('/wordpdf') }}">Word To Pdf</a></li>
                            <li><i class="fa fa-bars"></i><a href="{{ url('/xlsxcsv') }}">XLSX TO CSV</a></li>
                            <li><i class="fa fa-bars"></i><a href="{{ url('/csvxlsx') }}">CSV TO XLSX</a></li>
                      ...
                      <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">
                            <li><i class="fa fa-image"></i><a href="{{ url('/pngjpg') }}">PNG TO JPG</a></li>
