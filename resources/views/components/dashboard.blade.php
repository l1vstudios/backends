            ...
            <div id="main-menu" class="main-menu collapse navbar-collapse">
                <ul class="nav navbar-nav">
                    ...
                    <li class="menu-item-has-children dropdown">
                        ...
                        <ul class="sub-menu children dropdown-menu">                            <li><i class="fa fa-puzzle-piece"></i><a href="{{ url('/cvgenerator') }}">CV Generator</a></li>

                            <li><i class="fa fa-id-badge"></i><a href="ui-badges.html">PDF To Word</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">Word To Pdf</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">XLSX TO CSV</a></li>
                            <li><i class="fa fa-bars"></i><a href="ui-tabs.html">CSV TO XLSX</a></li>

                           
                        </ul>
                    </li>
                      <li class="menu-item-has-children dropdown">
                        <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"> <i class="menu-icon fa fa-image"></i>Tools Image</a>
                        <ul class="sub-menu children dropdown-menu">                            <li><i class="fa fa-image"></i><a href="ui-buttons.html">PNG TO JPG</a></li>
                            <li><i class="fa fa-image"></i><a href="ui-badges.html">JPG TO PNG</a></li>
                            <li><i class="fa fa-image"></i><a href="ui-tabs.html">PNG TO SVG</a></li>
                            <li><i class="fa fa-image"></i><a href="ui-tabs.html">WEBP TO PNG</a></li>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            <div class="stat-text"><span class="count">500</span></div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Layanan Aktif</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="stat-widget-five">
                                    ...
                                    <div class="stat-content">
                                        <div class="text-left dib">
                                            ...
                                            <div class="stat-heading">Layanan Offline</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-lg-4">
                                    <div class="card-body">
                                        <div class="progress-box progress-1">
                                            ...
                                            <div class="por-txt">250 Pengguna (50%)</div>
                                            <div class="progress mb-2" style="height: 5px;">
                                                <div class="progress-bar bg-flat-color-1" role="progressbar" style="width: 40%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="progress-box progress-2">
                                            <h4 class="por-title">User Aktif</h4>
                                            <div class="por-txt">500 Users (100%)</div>
                                            <div class="progress mb-2" style="height: 5px;">
                                                <div class="progress-bar bg-flat-color-2" role="progressbar" style="width: 24%;" aria-valuenow="25" aria-valuemin="0" aria-valuemax="100"></div>
                                            </div>
                                        </div>
                                        <div class="progress-box progress-2">
                                            <h4 class="por-title">User Tidak Aktif</h4>
                                            <div class="por-txt">0 Users (0%)</div>
                                            <div class="progress mb-2" style="height: 5px;">
